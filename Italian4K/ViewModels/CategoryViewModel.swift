...
final class CategoryViewModel: ObservableObject {
    ...
    @Published var categories: [Category] = [
        ...
        Category(title: "Adjectives", fileNames: ["adjectives"], isPremium: false),
        Category(title: "Body", fileNames: ["body"], isPremium: true),
        Category(title: "Collocations", fileNames: ["collocations"], isPremium: true),
        Category(title: "Cojugationed Verbs", fileNames: ["conjugations"], isPremium: true),
        ...
        Category(title: "Personality", fileNames: ["personality"], isPremium: false),
